...
namespace GameHooks 
{
    ...
    constexpr uintptr_t ADDR_VECTOR_SUM = 0xAE00;
    ...
    void InitVector3Hooks(uintptr_t gameBaseAddress) 
    {
        ...
        uintptr_t absoluteAddrSum = gameBaseAddress + ADDR_VECTOR_SUM;
        Memory::InstallHook(absoluteAddrSum, (void*)&Vector_Sum, 5);
    }
}